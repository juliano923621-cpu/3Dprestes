    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-6 font-sans">
      ...
      >
        ...
        {!isSupabaseConfigured && (
          <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-xl flex gap-3 text-amber-200 text-sm leading-relaxed">
            <AlertCircle className="shrink-0" size={18} />
            <p><strong>Atenção:</strong> Você precisa configurar as variáveis no menu superior (Settings) para o login funcionar.</p>
          </div>
        )}
